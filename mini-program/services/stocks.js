...
function searchStocks(query) { return request(`/api/stocks/search?q=${encodeURIComponent(query)}`); }
...
module.exports = { fetchTrackedStocks, fetchStockDetail, addTrackedStock, removeTrackedStock, searchStocks };
